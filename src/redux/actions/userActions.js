...
export const getUserDetails = (endpoint) => {
  return async (dispatch, getState) => {
    try {
      dispatch({
        type: actionsTypes.USER_DETAILS_REQUEST,
      });
      const {
        userLogin: { userInfo },
      } = getState();
      ...
      dispatch({
        type: actionsTypes.USER_DETAILS_FAIL,
        payload: message,
      });
    }
  };
...
export const updateUserProfile = (user) => {
  return async (dispatch, getState) => {
    try {
      dispatch({
        type: actionsTypes.USER_UPDATE_PROFILE_REQUEST,
      });
      const {
        userLogin: { userInfo },
      } = getState();
      ...
      dispatch({
        type: actionsTypes.USER_UPDATE_PROFILE_FAIL,
        payload: message,
      });
    }
  };
...
export const listUsers = () => {
  return async (dispatch, getState) => {
    try {
      dispatch({
        type: actionsTypes.USER_LIST_REQUEST,
      });
      const {
        userLogin: { userInfo },
      } = getState();
      ...
      dispatch({
        type: actionsTypes.USER_LIST_FAIL,
        payload: message,
      });
    }
  };
